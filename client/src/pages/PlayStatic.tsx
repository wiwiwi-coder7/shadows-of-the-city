...
export default function PlayStatic() {
  ...
  return <main className={playerClass} dir={locale === "fa" ? "rtl" : "ltr"} onKeyDown={onStoryKeyDown}>
    <div className="story-image" style={{ backgroundImage: `url(${publicAssetUrl(node.imageUrl)})` }} />
