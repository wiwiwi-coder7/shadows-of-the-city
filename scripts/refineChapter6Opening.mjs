...
Object.assign(nodes.CH6_S3_N01, {
  sceneTitle: "بازگشت اریکا",
  blocks: [
    { type: "dialogue", speaker: "اریکا", text: "کلمهٔ «رهبر» را پیدا کردید، نه؟ از قیافه‌تان معلوم است. قیافهٔ مردی را دارید که فهمیده هیولایی که دنبالش بوده، اسم دارد." },
    { type: "dialogue", speaker: "نیک", text: "تو می‌دانی او کیست." },
    { type: "dialogue", speaker: "اریکا", text: "نسخه‌ای از او را می‌شناسم. دانستن همهٔ او جان آدم‌های بهتری از ما را گرفته است. اما می‌توانم بیشتر بگویم؛ این بار فقط بهایش بیشتر است." },
  ],
  choices: [
    { id: "CH6_S3_N01-A", label: "مستقیم بپرس بهایش چیست.", target: "CH6_S3_N02A" },
    { id: "CH6_S3_N01-B", label: "بپرس چرا با بالارفتن خطر، قیمت هم بالا می‌رود.", target: "CH6_S3_N02B" },
    { id: "CH6_S3_N01-C", label: "پرونده‌های قدیمی بندرِ کرت را به‌عنوان حسن نیت پیشنهاد بده.", target: "CH6_S3_N02C" },
  ],
});

Object.assign(nodes.CH6_S3_N02, {
  sceneTitle: "بازگشت اریکا",
  blocks: [
    { type: "dialogue", speaker: "اریکا", text: "یک لطفِ بی‌پرده. با شرط‌های من و در زمان من، تا وقتی که معقول باشد. از شما نمی‌خواهم جان‌تان را بدهید؛ گاهی فقط شبتان را. در عوض، هرچه از حلقهٔ درونی رهبر دارم می‌گیرید: راه پول، زنجیرهٔ فرمان و شکل دستی که دور او حلقه زده." },
    { type: "dialogue", speaker: "نیک", text: "چرا کمک می‌کنی؟ می‌توانستی این را به کسی با جیب‌های عمیق‌تر بفروشی." },
    { type: "dialogue", speaker: "اریکا", text: "چون رهبر خیلی پیش‌تر از آن‌که به زندگی تو برسد، چیزی از من گرفت. اسمش را بگذار منفعت شخصی، با چاشنی یک کینهٔ قدیمی." },
  ],
  choices: [
    { id: "CH6_S3_N02-A", label: "بپرس دقیقاً چه چیزی از او گرفته شده است.", target: "CH6_S3_N03A" },
    { id: "CH6_S3_N02-B", label: "بی‌آن‌که گذشتهٔ او را بکاوی، معامله را بپذیر.", target: "CH6_S3_N03B" },
    { id: "CH6_S3_N02-C", label: "با او همدردی کن و بهای این کار را به رسمیت بشناس.", target: "CH6_S3_N03C" },
  ],
});

Object.assign(nodes.CH6_S3_N03, {
  sceneTitle: "بازگشت اریکا",
  blocks: [
    { type: "dialogue", speaker: "اریکا", text: "با چیزهایی که دادم محتاط باش. و نیک، وقتی برای گرفتن آن لطف آمدم، وقتت را صرف غافلگیری نکن. هشدار داده بودم." },
    { type: "narration", text: "پیش از آن‌که نیک فرصت پرسیدن پیدا کند، اریکا در غروب گم شده است. کاغذهای روی میز، برای نخستین‌بار، شبیه نقشهٔ راهی واقعی‌اند." },
    { type: "narration", text: "همان شب، حوزه تقریباً خالی است. کرت پشت میز منتظر نشسته و کشوی قفل‌شده‌ای را باز گذاشته است؛ پوشه‌ای باریک و فرسوده جلویش، قدیمی‌تر از هر پروندهٔ معمولی اداره." },
  ],
});

Object.assign(nodes.CH6_S4_N01, {
  sceneTitle: "حوزه پس از ساعت اداری",
  blocks: [
    { type: "dialogue", speaker: "کرت", text: "دربارهٔ ادین شنیدم. متأسفم. از همان کمی که دیدم، مرد خوبی به‌نظر می‌رسید." },
    { type: "dialogue", speaker: "نیک", text: "بود." },
    { type: "dialogue", speaker: "کرت", text: "برای همین امشب صدایت کردم. از پیش از شکایت دویل روی این موضوع نشسته بودم؛ از پیش از آن‌که آن نشان لعنتی روی میزم ظاهر شود. اول به خودم گفتم دارم از شغلم محافظت می‌کنم. بعد فهمیدم مدت زیادی‌ست فقط دارم خودم را قایم می‌کنم." },
  ],
  choices: [
    { id: "CH6_S4_N01-A", label: "پیش از ادامهٔ حرفش بپرس در پوشه چیست.", target: "CH6_S4_N02A" },
    { id: "CH6_S4_N01-B", label: "پیش از دیدنش، برای اعتمادش تشکر کن.", target: "CH6_S4_N02B" },
    { id: "CH6_S4_N01-C", label: "بپرس چرا این‌همه مدت صبر کرده است.", target: "CH6_S4_N02C" },
  ],
});

Object.assign(nodes.CH6_S4_N02, {
  sceneTitle: "حوزه پس از ساعت اداری",
  blocks: [
    { type: "narration", text: "نیک پوشه را باز می‌کند: پروندهٔ پرسنلی قدیمی خودش؛ تقدیرنامه‌ها، سابقه‌ای تمیز، و شغلی که از یادآوردنش هیچ حس کاملی ندارد. انتهای پوشه، یادداشت‌های داخلیِ به‌شدت سانسورشده از هفته‌های پیش از اخراج اوست." },
    { type: "narration", text: "یک جمله زیر سانسور جا مانده است: «همکاری آزمودنی از طریق [سانسورشده] تضمین شده است. انتقال به نظارت خارجی توصیه می‌شود: رابط روکری.»" },
