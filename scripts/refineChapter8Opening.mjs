...
Object.assign(nodes.CH8_S3_N01, {
  sceneTitle: "حساب آدری",
  blocks: [
    { type: "dialogue", speaker: "آدری", text: "یک سال از مردی متنفر بودم که شاید دیگر وجود نداشت؛ یا شاید هیچ‌وقت آن‌طور که من در ذهنم ساختم وجود نداشت. اسلحه‌ای با صورت تو را فرستاده بودند تا کارشان را تمام کند. و تمام این مدت، تو پول جمع کرده بودی و بعد همان پول را به من دادی." },
    { type: "dialogue", speaker: "نیک", text: "می‌دانم شنیدن همه‌اش یک‌باره زیادی است." },
    { type: "dialogue", speaker: "آدری", text: "زیادی نیست؛ همه‌چیز است. ادین است، سازمانی که هر دومان را زخمی کرد، چهار سال از عمرم که یاد گرفتم برای زنده‌ماندن سرد باشم. و تویی که حالا می‌فهمم من را به چیزی که از تو می‌خواستند ترجیح دادی. نمی‌دانم چطور سپاس و سوگ و ترس قدیمی را هم‌زمان نگه دارم، بی‌آن‌که یکی‌شان بشکند." },
  ],
  choices: [
    { id: "CH8_S3_N01-A", label: "بگو لازم نیست امشب همه‌چیز را حل کند.", target: "CH8_S3_N02A" },
    { id: "CH8_S3_N01-B", label: "بپذیر که خودت هم هنوز نمی‌دانی برای هم چه هستید.", target: "CH8_S3_N02B" },
    { id: "CH8_S3_N01-C", label: "نزدیک‌تر شو و بی‌کلام دستت را پیش ببر.", target: "CH8_S3_N02C" },
  ],
});

Object.assign(nodes.CH8_S3_N02, {
  sceneTitle: "حساب آدری",
  blocks: [
    { type: "narration", text: "هر شکلی که این لحظه پیدا کند، چیزی میانشان روی پشت‌بام می‌ماند؛ نه پاسخ و نه پایان تمیز، فقط آرامش شکنندهٔ دو نفری که دیگر دروغی برای کشف‌کردن میانشان نمانده است." },
    { type: "dialogue", speaker: "آدری", text: "بنی، اگر این اسم واقعاً اسم اوست، با هر دوی ما کار خودش را کرده. می‌خواهم چیزی را که از من گرفت، پس بگیرم. بیشتر از این‌که بخواهم همین حالا بدانم من و تو چه هستیم." },
    { type: "dialogue", speaker: "نیک", text: "پس برویم چیزی از او پس بگیریم، به‌جای این‌که فقط از چیزهایی که گرفته جان سالم در ببریم." },
    { type: "dialogue", speaker: "آدری", text: "با این یکی می‌توانم کنار بیایم." },
    { type: "narration", text: "آفتاب از پشت‌بام‌های شهر بالا می‌آید؛ طلایی، بی‌تفاوت، و بی‌خبر از سنگینی شب. جایی دور، بنی احتمالاً مهره‌ها را جابه‌جا می‌کند، بی‌آن‌که بداند دو نفر شروع کرده‌اند روبه‌رویش بازی کنند. این فکر برای نخستین‌بار نیک را آن‌طور که باید، نمی‌ترساند." },
  ],
});
